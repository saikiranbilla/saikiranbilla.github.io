  ...
  root.innerHTML = `
    ...
    <main class="page">
      ...
      <header class="header">
        ...
        <div class="bio">
          <p>I'm Sai. I'm an incoming forward deployed engineer at Perficient. Previously, I went to UIUC and did my masters in Information Management. I like building things and I like talking to people — FDE lets me do both.</p>
